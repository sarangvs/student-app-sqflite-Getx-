                      ...
                      Center(
                        child: ElevatedButton(
                            onPressed: (){
                              ...
                              String sName = studentController.studentNameController.text;
                              String sClass = studentController.studentClassController.text;
                              String sDiv = studentController.rollnumberController.text;
                              String sAge = studentController.ageController.text;
                              String sGender = studentController.selectedValue;
                              String sAddress = studentController.addressController.text;

                              studentController.addStudentToDb(sName,sClass,sDiv,sAge,sGender,sAddress);
